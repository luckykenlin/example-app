...
@section("title")
    <title>{{ config('app.name') }} | Terms and Conditions</title>
@endsection
...
@section('content')
    <div role="main" class="main">
            ...
            <div class="container">
                <div class="row py-5">
                    <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                        <h1 class="text-color-dark font-weight-bold">Terms and Conditions</h1>
                    </div>
                    <div class="col-md-4 order-1 order-md-2 align-self-center">
                        <ul class="breadcrumb d-flex justify-content-md-end text-3-5">
                            <li><a href="{{route('home')}}" class="text-color-default text-color-hover-primary text-decoration-none">HOME</a></li>
        ...
        <section class="section bg-color-light position-relative border-0 pt-0 m-0 appear-animation" data-appear-animation="fadeIn"
            ...
            <div class="container">
                <div class="static-panel">
                    ...
                    <p class="p1"><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Go3tech</p>
                    <p class="p1"><strong>Application Store</strong> means the digital distribution service operated and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the Application has been downloaded.</p>
                    <p class="p1"><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</p>
                    <p class="p1"><strong>Country</strong> refers to: New York, United States</p>
                    <p class="p1"><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Go3Technology Inc, 50 Broad St, Suite 1637, NY 10004.</p>
                    <p class="p1"><strong>Device</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</p>
                    <p class="p1"><strong>Service</strong> refers to the Application or the Website or both.</p>
                    <p class="p1"><strong>Third-party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</p>
                    <p class="p1"><strong>Website</strong> refers to Go3Technology, accessible from www.go3technology.com</p>
                    <p class="p1"><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
                    ...
                    <p class="p1">We may terminate or suspend Your access immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</p>
                    <p class="p1">Upon termination, Your right to use the Service will cease immediately.</p>
                    ...
                    <p class="p2"><span class="s1">For European Union (EU) Users</span></p>
                    <p class="p1">If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.</p>
                    ...
                    <p class="p3"><strong>Severability</strong></p>
                    ...
                    <p class="p3"><strong>Waiver</strong></p>
                    <p class="p1">Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not effect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>
                    ...
                    <p class="p4">By email: Support@go3technology.com</p>
                    <p class="p4">By visiting this page on our website: www.go3technology.com</p>
                    <p class="p4">By phone number: 888-377-3818</p>
                </div>
            </div>
        </section>
